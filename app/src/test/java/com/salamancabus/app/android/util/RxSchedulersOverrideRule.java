package com.salamancabus.app.android.util;
 ...
 * caches the schedulers in memory. So if one of the test classes doesn't use this rule by the time
 ...
 * RxJava plugins this may affect the behaviour of the testing method.
 */
